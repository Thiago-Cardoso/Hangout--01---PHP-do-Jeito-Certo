...
$loginTransaction = new tNG_login($conn_lojavirtual);
...
?></div></td>
    ...
    <tr>
      <td valign="top"><div class="container_conteudo">
        
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="header_conteudo">Admin</td>
            </tr>
          <tr>
